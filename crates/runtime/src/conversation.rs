...
mod tests {
    ...
    fn shell_snippet(script: &str) -> String {
        match script {
            ...
            "printf 'broken hook'; exit 1" => cmd_write("broken hook", 1),
            "printf 'pre hook ran'" => cmd_write("pre hook ran", 0),
            "printf 'post hook ran'" => cmd_write("post hook ran", 0),
            "printf 'post hook should not run'" => cmd_write("post hook should not run", 0),
